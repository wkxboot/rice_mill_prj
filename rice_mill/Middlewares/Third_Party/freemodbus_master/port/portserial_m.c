...
UART_HandleTypeDef * ptr_host_modbus_uart_handle =&huart1;
...
void vMBMasterPortSerialEnable(BOOL xRxEnable, BOOL xTxEnable)
{
   ...
   if(xTxEnable)
    ...
    //__HAL_UART_ENABLE_IT(ptr_host_modbus_uart_handle, UART_IT_TXE);
     ...
     APP_LOG_WARNING("MB [disable TX ]!\r\n"); 
    }
}

void vMBMasterPortClose(void)
{
     APP_LOG_WARNING("easy modbus serial close!\r\n"); 
}
...
void EASY_MODBUS_USARTIRQHandler( void )
{
